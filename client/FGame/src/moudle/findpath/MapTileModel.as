package moudle.findpath
{
	...
	public class MapTileModel
	{
		...
		{
			var newX : Number = Math.floor((x + SceneConfig.TILE_WIDTH / 2) / SceneConfig.TILE_WIDTH);
			var newY : Number = Math.floor((y + SceneConfig.TILE_HEIGHT / 2) / SceneConfig.TILE_HEIGHT);
		...
		{
			var newX : Number = SceneConfig.TILE_WIDTH * x;
			var newY : Number = SceneConfig.TILE_HEIGHT * y;
			return new Point(newX, newY);
		}
	}
}
