...
;
        ...
        static void GenerateProtocolBuffersFiles()
        {
            ...
            string arguments = String.Format("--python_out=. {0}", 
            ...
            System.IO.File.Move(System.IO.Path.GetFileNameWithoutExtension(szOutputProtoFile) + "_pb2.py",
                szOutputDirectory + System.IO.Path.GetFileNameWithoutExtension(szOutputProtoFile) + "_pb2.py");
        }
